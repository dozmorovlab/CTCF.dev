...
# Output files
fileNameOut1 <- file.path(dir_data, "results/hg18.CTCFBSDB.CTCF_predicted_human.RData")
fileNameOut1.1 <- file.path(dir_data, "results/hg18.CTCFBSDB.CTCF_predicted_human.bed")
fileNameOut2 <- file.path(dir_data, "results/mm8.CTCFBSDB.CTCF_predicted_mouse.RData")
fileNameOut2.1 <- file.path(dir_data, "results/mm8.CTCFBSDB.CTCF_predicted_mouse.bed")
