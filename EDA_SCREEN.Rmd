...
# Output files
fileNameOut1 <- file.path(dir_data, "results/CTCF_hg38_SCREEN.RData")
fileNameOut2 <- file.path(dir_data, "results/CTCF_mm10_SCREEN.RData")
```
...
save(list = mtx_to_gr(mtx = mtx_human, genome_id = "hg38"), file = fileNameOut1)
save(list = mtx_to_gr(mtx = mtx_mouse, genome_id = "mm10"), file = fileNameOut2)
